 ...
 * @author 6
 */
public class GUI_Assistant extends Application{
    Scene scene;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        listView.getStylesheets().addAll(GUI_Assistant.class.getResource("css.css").toExternalForm());
        
        primaryStage.setTitle("Vivlio - Assistant");
    ...
    public VBox wrapper(ArrayList<String> livres){
        ...
        search.getStylesheets().addAll(GUI_Assistant.class.getResource("css.css").toExternalForm());
        ObservableList<String> data = FXCollections.observableArrayList();
        ListView<String> listView = new ListView<String>(data);
        ...
        */
        ...
        VBox v2  = this.statisticsValue("EMPRUNTS",assistant.savoirReservationEncours().size(),"-fx-background-color:#34F2B9");
    ...
    public VBox statisticsValue(String str,int nombre,String color){
        ...
        vertical.setId("hbox");
        vertical.getStylesheets().addAll(GUI_Assistant.class.getResource("css.css").toExternalForm());
        return vertical;
    }
    ...
    public ScrollPane AjouterLivre(){
        ...
        etat.getItems().addAll("Bon","Moyen","Abimé");
        etat.setValue("Etat");
        ...
        livre.setId("hbox");
        livre.getStylesheets().addAll(GUI_Assistant.class.getResource("button.css").toExternalForm());
    ...
    public VBox livreBox_reservation(FicheAdherent o,int v){
        ...
        Label livretitre = new Label("Livre:"+o.getOuvrage().getTitre());  
        livretitre.setFont(new Font("Calibri",16));
